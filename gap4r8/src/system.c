...
#endif
#else
	syBuf[0].fp = _fileno(stdin);
	syBuf[0].bufno = -1;
	syBuf[0].echo = _fileno(stdout);
	syBuf[0].isTTY = 0;
	syBuf[1].fp = _fileno(stdout);
	syBuf[1].bufno = -1;
	syBuf[1].echo = _fileno(stdout);
	syBuf[1].isTTY = 0;
	syBuf[2].fp = _fileno(stderr);
	syBuf[2].bufno = -1;
	syBuf[2].echo = _fileno(stderr);
	syBuf[2].isTTY = 0;
	syBuf[3].fp = _fileno(stderr);
	syBuf[3].bufno = -1;
	syBuf[3].echo = _fileno(stderr);
	syBuf[3].isTTY = 0;
#endif
