...
#ifdef HPCGAP
		IS_IN(TLS(Symbol), S_INT|S_TRUE|S_FALSE|S_CHAR|S_STRING|S_LBRACK|S_REC|S_FUNCTION|S_DO|S_ATOMIC|S_FLOAT|S_DOT|S_MAPTO)
#else
		IS_IN(TLS(Symbol), S_INT|S_TRUE|S_FALSE|S_CHAR|S_STRING|S_LBRACK|S_REC|S_FUNCTION|S_ATOMIC|S_FLOAT|S_DOT|S_MAPTO)
#endif
		)
    {
